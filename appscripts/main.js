//function for the opening of the 'Do you own a pet" -> "Yes" "No" tabs
...
//function for accordion under "No" tab
...
//function to get the result of the personality quiz
function getResult() {
    //getting the value of each question in the personality quiz (depends on radio button checked)
    let total = 0;
    ...
    //calculating the score of the personality quiz
    total =
        parseInt(q1) +
        parseInt(q2) +
        parseInt(q3) +
    ...
    if (total > 0) {
        ...
        'You are a dog person. The results show that you are an extrovert and <a href = "https://www.mckendree.edu/academics/scholars/issue18/paluska.htm#:~:text=Similarly%2C%20personality%20traits%20like%20introversion,%2C%20%26%20Potter%2C%202010)." id="darka">research</a> have shown that people who exhibit extroverted traits get along better with dogs.';
    } else if (total < 0) {
        document.getElementById("result").innerHTML =
        'You are a cat person. The results show that you are an introvert and <a href = "https://www.mckendree.edu/academics/scholars/issue18/paluska.htm#:~:text=Similarly%2C%20personality%20traits%20like%20introversion,%2C%20%26%20Potter%2C%202010)." id="darka">research</a> have shown that people who exhibit introverted traits get along better with cats.';
    } else {
        document.getElementById("result").innerHTML =
        'You are both a cat and dog person. The results show that you are an ambivert. <a href = "https://www.mckendree.edu/academics/scholars/issue18/paluska.htm#:~:text=Similarly%2C%20personality%20traits%20like%20introversion,%2C%20%26%20Potter%2C%202010)." id="darka">Research</a> have shown that people who exhibit extroverted traits get along better with dogs, and those who exhibit introverted traits get along better with cat. As someone who exhibits both traits, you will get along well with both animals!';
    }
};

//function to clear all selection of radio buttons
...
//event listener for when the "get results" button is clicked
document.getElementById("testButton").addEventListener ("click", function(){
    ...
    const q6 = document.querySelector('input[name="question6"]:checked');
    const q7 = document.querySelector('input[name="question7"]:checked');
    const q8 = document.querySelector('input[name="question8"]:checked');
    ...
    //alerts for when any of the questions are not answered
    if (!q1) {
        window.alert("You have not answered Question 1.")
    } else if (!q2) {
        window.alert("You have not answered Question 2.")
    } else if (!q3) {
        window.alert("You have not answered Question 3.")
    } else if (!q4) {
        window.alert("You have not answered Question 4.")
    } else if (!q5) {
        window.alert("You have not answered Question 5.")
    } else if (!q6) {
        window.alert("You have not answered Question 6.")
    } else if (!q7) {
        window.alert("You have not answered Question 7.")
    } else if (!q8) {
        window.alert("You have not answered Question 8.")
    } else if (!q9) {
        window.alert("You have not answered Question 9.")
    } else if (!q10) {
        window.alert("You have not answered Question 10.")
    } else {
        getResult();
        refreshTest();
    }
...
//map graphs under "Yes" tab
d3.csv("https://raw.githubusercontent.com/caseylock-nm2207/caseylock-nm2207.github.io/main/resources/petsdata.csv", function (err, rows) {
    ...
    Plotly.newPlot("mapGraph", data, layout, { showLink: false });
}
);
...
d3.csv( "https://raw.githubusercontent.com/caseylock-nm2207/caseylock-nm2207.github.io/main/resources/petsdata.csv", function (err, rows) {
    ...
    Plotly.newPlot("mapGraph2", data, layout, { showLink: false });
}
);

//bar graph under "Getting a pet for better mental health"
const wellbeing = [
    "Depression",
    "Loneliness",
    "Self-Esteem",
...
//radar graph under personality quiz in "No" tab
const personality = [
    "Openness",
    "Agreeableness",
    "Conscientiousness",
    ...
    datasets: [
        {
            ...
            backgroundColor: "rgba(99, 140, 110, 0.5)",
        },
        {
            label: "Dog Owners",
            data: [3.65, 3.92, 4.02, 2.72, 2.64],
            backgroundColor: "rgba(118, 120, 121, 0.5)",
        },
    ],
};
...
//stacked bar graph under "Getting a pet for better mental health"
...
//stacked bar graph under "Getting a pet for the elderly"
...
//bar graph under "Getting a pet for children"
const childDev = [
    "Social Activator",
    "Hypersensitive",
    "Reassurance",
...
//benefits under "Getting a pet for better mental health"
const mentalB1 = document.querySelector("#mentalB1");

mentalB1.addEventListener("mouseenter", () => {
    //turning effect of the content when the mouse hovers over the benefit
    mentalB1.querySelector("span").innerHTML =
    "Playing with a dog or cat can elevate levels of serotonin and dopamine, which is calming and relaxing.";
});

mentalB1.addEventListener("mouseleave", () => {
    //turning effect of the title when the mouse leaves
...
//benefits under "Getting a pet for the elderly"
...
//benefits under "Getting a pet for children"
...
//function to present the data in the "Advice given by pet owners" accordion in the "No" tab in the form of lists
function getData() {
...
//function to store the data from the 'giving advice' part in "Yes" tab
function updateData() {
...
//function to clear the texts in the textbox
function refreshAdvice() {
    const petText = document.getElementById("pet");
...
//event listener for when the "submit response" button is clicked
...
adviceButton.addEventListener("click", function () {
    ...
    const adviceValue = document.getElementById("advice").value
    let submitAdvice;

    //alerts for when any of the blanks are not filled
    //prevent submission of responses when any of the blanks are not filled
    if (petValue.length == 0) {
        window.alert("You have not filled in the blank for cat or dog.");
        submitAdvice = false;
    } else if (breedValue.length == 0) {
        window.alert("You have not filled in the blank for your pet's breed.");
        submitAdvice = false;
    } else if (adviceValue.length == 0) {
        window.alert("You have not filled in the blank for your advice or suggestion.");
        submitAdvice = false;
    } else {
        updateData();
        refreshAdvice();
