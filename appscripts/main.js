...
function advice() {
    let textBox = document.getElementById("givenadvice");
    let pet = document.getElementById("pet").value;
    let breed = document.getElementById("breed").value;
    let advice = document.getElementById("advice").value;
    let text =
        "Pet: " + pet + "<br>Breed: " + breed + "<br>Advice/suggestion: " + advice;
...
document.getElementById("button").addEventListener("click", function () {
    ...
    refresh();
    window.alert(
        "Thank you for you advice/suggestion. Wishing you a good day ahead :D"
    );
});
